...
export const MIN_JOBS_FOR_PROFESSION_INDEX = 3;
export const MIN_OBSERVATIONS_FOR_SALARY_INDEX = 5;
export const SITEMAP_JOBS_PER_PAGE = 10000;
export const DEFAULT_JOB_VALID_DAYS = 90;
